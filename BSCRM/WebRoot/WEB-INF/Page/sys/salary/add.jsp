...
<script src="${pageContext.request.contextPath}/ui/datepicker97/WdatePicker.js" type="text/javascript"></script>
	<script language="javascript">
		...
		function setTime(){
			$("#payday").val(getCurTime().substring(0, 10)) ;
		}
...
<div class="control">
	<button type='button' class='button' onMouseOver="this.className='button_over';" 
	        onMouseOut="this.className='button';"  onClick="AddSalary();">
  	...
  	<td>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td>
					<s:textfield id="userId" name="userId" cssStyle="width:90%" cssClass="validate[required,custom[integer],maxSize[10]]" onblur="validateUser();"/>
				</td>
			</tr>
			<tr>
				<td>员工姓名：</td>
