...
<script language="javascript">
	...
	function UpdateSysRole() {
		...
		if(validate){
			var params = {"roleId":roleId,"roleName":roleName,"remark":remark};
			var url = "sysRoleAction_Update.do";
			$.post(  
					 url, 
				     params, 
				     function(json){
...
<body>
<s:form id="form1" name="form1"  method="post" action="sysRoleAction_Update.do">
...
<div class="control">
	<button type='button' class='button' onMouseOver="this.className='button_over';" 
	        onMouseOut="this.className='button';"  onClick="UpdateSysRole()">
