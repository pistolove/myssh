	...
	<script language="javascript">
		...
		function validateUserName(){
			...
			if(name!=""){
				...
				var url = "sysUserAction_CheckUserName.do";
				$.post(
					 url, 
				     params, 
				     function(json){
				     	if(json){
				     		alert("系统中已有用户名为[ "+name+" ]的员工!请重新添加用户名!");
				     		$("#name").val(null);
							$("#name").focus();
				     		return;
				     	}
...
<div class="control">
	<button type='button' class='button' onMouseOver="this.className='button_over';" 
	        onMouseOut="this.className='button';"  onClick="AddUser();">
  	...
  	<td>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td class="red">用户名：</td>
				<td>
					<s:textfield id="name" name="name" cssStyle="width:90%" cssClass="validate[required,maxSize[20]]" onblur="validateUserName();"/>
				</td>
				<td class="red">中文名：</td>
				<td>
			...
			<tr>
				<td class="red">密码：</td>
				<td>
					<s:textfield id="password" name="password" cssStyle="width:90%" cssClass="validate[required,maxSize[50]]"/>
				</td>
				<td>推荐人：</td>
				<td>
			...
			<tr>
				...
				<td>
					<s:select list="%{roleList}" id="roleId" name="roleId" listKey="roleId" listValue="roleName" 
						...
						cssStyle="width:90%" cssClass="validate[required]"/>
               </td>
  	...
  	<td>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td>创建人：</td>
				<td>
					<s:textfield id="creator" name="creator" value="系统管理员" cssStyle="width:90%" readonly="true" cssClass="disabled"/>
				</td>
				<td>创建时间：</td>
				<td>
					<s:textfield id="createTime" name="createTime" cssStyle="width:90%" value="2010-08-30 22:55:46" readonly="true" cssClass="disabled"/>
				</td>
			</tr>
			<tr>
				<td>修改人：</td>
