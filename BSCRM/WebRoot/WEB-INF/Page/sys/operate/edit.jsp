...
<script language="javascript">
	...
	function UpdateOperate() {
		...
		if(validate){
			var params = {"operateId":operateId,"operateName":operateName,"operateUrl":operateUrl};
			var url = "operateAction_Update.do";
			$.post(  
					 url, 
				     params, 
				     function(json){
...
<body>
<s:form id="form1" name="form1"  method="post" action="operateAction_Update.do">
<s:hidden id="operateId" name="operateId"></s:hidden>
<div class="mtitle">
...
<div class="control">
	<button type='button' class='button' onMouseOver="this.className='button_over';" 
	        onMouseOut="this.className='button';"  onClick="UpdateOperate()">
